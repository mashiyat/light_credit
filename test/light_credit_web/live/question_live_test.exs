defmodule LightCreditWeb.QuestionLiveTest do
  use LightCreditWeb.ConnCase

  import Phoenix.LiveViewTest
  import LightCredit.CreditEvaluationFixtures

  @create_attrs %{category: "some category", points: 42, question_text: "some question_text", step_number: 42}
